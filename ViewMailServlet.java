	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session==null){
			...
			try{
				...
				if(rs.next()){
					out.print("<img src=\"open.png\" width=\"50\" height=\"50\"/><h1>"+rs.getString("subject")+"</h1><hr/>");
					out.print("<h2><b>Message:</b><br/> "+rs.getString("message")+" <br/> <br/><br/><b>By: "+rs.getString("sender")+"</b></h2>"+
					"<a href='ComposeServlet?receiver="+rs.getString("SENDER")+"'><img src=\"reply.png\" width=\"50\" height=\"50\"/></a>");
